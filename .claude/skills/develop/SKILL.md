...
1. **Prep**: read `docs/design.md` (product brief) and `docs/tasks.md` (task tracker) to understand the
   spec/constraints for the task at hand.
...
4. **Update progress docs**: update `docs/tasks.md` to check off the completed item(s) and note any new
   follow-up tasks discovered along the way. No broader spec-consistency check is performed here.
