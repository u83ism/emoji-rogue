 ...
 * should reveal a potion-family kind's real name. Split out of messages.ts
 * (milestone 98 follow-up) once that file passed the 200-line
 * structure-lint limit — formatEvent's switch was the overwhelming share of
 * it.
 */
