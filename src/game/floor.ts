...
import { POTION_COUNT_PER_FLOOR, ZOMBIE_MAX_HP } from "./balance.js";
 ...
 * zombies, the down staircase and POTION_COUNT_PER_FLOOR potions drawn from
 * the spawn pool. Nothing shares a tile with anything else unless the pool
 * ran dry (tiny fully-visible maps).
 */
